...
# =====================================================================================
# disk_alert.sh
# Check the systems disk usage of /(root directory) or any mount point.
...
if [ "${disk_usage_percent}" -gt 80 ]; then
        echo -e "$(date) \033[0;33mWARNING: Disk Usage on ${TARGET} is ${disk_usage_percent}%." >> disk_alert.log
else
